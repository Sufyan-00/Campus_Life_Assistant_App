...
class _ClassscheduleWidgetState extends State<ClassscheduleWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.connect = await actions.checkInternetConnection();
    });
  }
                    ...
                    child: Material(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              20.0, 20.0, 20.0, 20.0),
                          child: FutureBuilder<List<GetallclassesRow>>(
                            future: SQLiteManager.instance.getallclasses(),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                              ...
                              final columnGetallclassesRowList = snapshot.data!;
                              ...
                              return Column(
                                ...
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceEvenly,
                                children: List.generate(
                                    columnGetallclassesRowList.length,
                                    (columnIndex) {
                                  final columnGetallclassesRow =
                                      columnGetallclassesRowList[columnIndex];
                                  return Padding(
                                    padding: const EdgeInsets.all(4.0),
                                    child: SizedBox(
                                      height: 99.0,
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(4.0),
                                              child: Text(
                                                columnGetallclassesRow.location,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodySmall
                                                    .override(
