...
class _SignuppageWidgetState extends State<SignuppageWidget>
  ...
  void initState() {
    ...
    _model.conSignupPasswordTextController ??= TextEditingController();
    _model.conSignupPasswordFocusNode ??= FocusNode();
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          width: double.infinity,
                          child: TextFormField(
                            controller: _model.signupEmailAddressTextController,
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          width: double.infinity,
                          child: TextFormField(
                            controller: _model.conSignupPasswordTextController,
                            focusNode: _model.conSignupPasswordFocusNode,
                            autofocus: false,
                            autofillHints: const [AutofillHints.password],
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: InkWell(
                                onTap: () => safeSetState(
                                  () => _model.conSignupPasswordVisibility =
                                      !_model.conSignupPasswordVisibility,
                                ),
                                focusNode: FocusNode(skipTraversal: true),
                                child: Icon(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.signupPasswordTextController.text !=
                                  _model.conSignupPasswordTextController.text) {
