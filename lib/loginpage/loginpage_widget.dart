...
class _LoginpageWidgetState extends State<LoginpageWidget>
  ...
  void initState() {
    ...
    _model.signinEmailAddressTextController ??= TextEditingController();
                  ...
                  children: [
                    Padding(
                      ...
                      child: SizedBox(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.signinEmailAddressTextController,
                          focusNode: _model.signinEmailAddressFocusNode,
                          autofocus: true,
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            final user = await authManager.signInWithEmail(
                              context,
                              _model.signinEmailAddressTextController.text,
