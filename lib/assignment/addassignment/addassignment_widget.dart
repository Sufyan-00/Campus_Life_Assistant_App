...
class _AddassignmentWidgetState extends State<AddassignmentWidget> {
  ...
  void initState() {
    ...
    _model.setDateTextController ??= TextEditingController();
    _model.setDateFocusNode ??= FocusNode();
  }
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: TextFormField(
                                        controller:
                                            _model.setDateTextController,
                                        focusNode: _model.setDateFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'Deadline',
                                        ...
                                        minLines: 1,
                                        validator: _model
                                            .setDateTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        safeSetState(() {
                                          _model.setDateTextController?.text =
                                              dateTimeFormat(
                                                  "EEE, MMM d - h:mm a",
                                                  _model.datePicked);
                                        });
                                  ...
                                  onPressed: () async {
                                    await AssignmentRecord.collection
                                        ...
                                        .set(createAssignmentRecordData(
                                          ...
                                          deadline:
                                              columnAssignmentRecord?.deadline,
                                          note: _model
